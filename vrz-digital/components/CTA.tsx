  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/5 p-8 md:p-10">
      <div className="grid gap-6 md:grid-cols-2 md:items-center">
        <div>
          <h3 className="text-2xl font-semibold">Menjünk egy kört</h3>
          <p className="mt-2 text-white/60">
            20 perc alatt átnézzük, hol folyik el a teljesítmény (kreatív, célzás, landing, mérés),
            és kapsz egy tiszta “mi legyen a következő lépés” listát.
          </p>
        </div>
